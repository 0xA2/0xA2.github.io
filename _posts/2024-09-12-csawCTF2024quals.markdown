...
<p></p>
<p>For this challenge we get a huge file with mostly hex encoded text. There are two strings that jump out since they seem to use some other type of encoding. Looking at the name and description of the challenge we can guess that a <a href="https://www.dcode.fr/twin-hex-cipher"><b>Twin Hex Cipher</b></a> has been used on the two strings. Throwing them in a Twin Hex Cipher decoder gets us the flag.</p>
