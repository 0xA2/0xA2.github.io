...
ul {
 ...
 <title>Midnight Sun CTF 2019 Quals Write-Up: open-gyckel-crypto - LostMyPlaintext</title>
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          ...
          <!-- Image -->
          <img class="center" src="/../../../assets/images/gyckel.png" alt="Card image cap">
          <div class="card mb-4">
            <div class="card-body">
              <p></p>
...
<span style="color: #66d9ef">for</span> <span style="color: #f8f8f2">carry</span> <span style="color: #f92672">in</span> <span style="color: #f8f8f2">range(</span><span style="color: #ae81ff">1</span><span style="color: #f8f8f2">,</span><span style="color: #ae81ff">10</span><span style="color: #f8f8f2">):</span>
