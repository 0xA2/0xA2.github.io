...
<p></p>
<p>We know that in RSA the value <b>n</b> is equal to <b>p*q</b> where <b>p</b> and <b>q</b> are two primes (in this case the two primes being generated by the "gen_prime" function) so let's write <b>p</b> and <b>q</b> (using the information given to us) the following way:</p>
<ul>
...
<ul>
	...
	<li>(We know this inverse modulo must exist because gcd(a<sup>30</sup>,2<sup>64</sup>) = 1)</li>
